          ...
          <div className="col-lg-12">
            <div className="breadcrumb-main">
              <h4 className="text-capitalize breadcrumb-title">
                Recordar Password de Acceso a SIPAM
              </h4>
          ...
          <div className="col-lg-12">
            <div className="card card-Vertical card-default card-md mb-4">
              ...
              <div className="card-body py-md-30">
                <h4>
                  Por favor ingrese su correo electrónico, si está registrado el
                  sistema SIPAM le enviará un enlace temporal para que haga el
...
export default FormRecordarpassword;
