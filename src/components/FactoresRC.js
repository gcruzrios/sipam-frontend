...
import ListBeneficiosRC from "./ListBeneficiosRC";
...
const FactoresRC = () => {
  ...
  const getDataPam = async (e) => {
   ...
   await axios
      .post("/wsSIPAM/GetListaFactorLey", cedula_pam, {
          ...
          <div className="col-lg-12">
            <div className="breadcrumb-main">
              <h4 className="text-capitalize breadcrumb-title">
                Lista de Factores (Montos Aprobados x Modalidad x Ley )
              </h4>
